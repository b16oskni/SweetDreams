        ...
        <script>
            ...
            window.onload = function () {
                ...
                selectFamily.addEventListener('click', (event) => {
                    getData("https://imdb-api.com/en/API/Title/k_pkixmotc/tt0182576", imdbFamily);
                });
                //BOBS BURGER EVENTS
                ...
                selectBob.addEventListener('click', (event) => {
                    getData("https://imdb-api.com/en/API/Title/k_pkixmotc/tt1561755", imdbBob);
                });
                //CLEVELAND EVENTS
                ...
                selectCleveland.addEventListener('click', (event) => {
                    getData("https://imdb-api.com/en/API/Title/k_pkixmotc/tt1195935", imdbCleveland);
                });
            }
            function randomiseEpisode(seasons, imdbKey) {
                ...
                if (modalElement.style.display != 'block') {
                    ...
                    getData('https://imdb-api.com/en/API/SeasonEpisodes/k_pkixmotc/' + imdbKey + '/' + randomSeason)
                }
            }
